...
exports = module.exports = function() {
  ...
  sellerInfo = function sellerInfo(iParam, iCallback) {
    ...
    iMP       = (iParam && iParam.marketplace)  ? iParam.marketplace  : mpDef;
    ...
    returnData = {
      ...
      "name": null,
      "url": {
        "mobile": ('http://' + mpList[iMP].url + urlList.info.mobile).replace('{{sellerId}}', iSellerId),
        "full": ('http://' + mpList[iMP].url + urlList.info.full).replace('{{sellerId}}', iSellerId)
      },
      "feedback": {
        "star": null,
        "rating": null,
